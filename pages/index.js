      ...
      <div style={{ padding: 20, display: 'flex', flexFlow: 'column nowrap', justifyContent: 'center', alignItems: 'center' }}>
        ...
        <Dialog onClose={() => setIsDialogOpen(false)} open={isDialogOpen}>
              ...
              <DialogContent>
                ...
                <br />
                <DialogContentText>
                  <span className={robotoCondensed.className} style={{ fontSize: 18 }}>Questions, inquiries, feedback, bug reports, and feature requests may be emailed to <a style={{ color: 'blue' }} href="mailto:contact@legion-hq.com">contact@legion-hq.com</a> or may be sent in a direct message to nick on the Armada Hub discord server.</span>
                </DialogContentText>
                <br />
                <DialogContentText>
