...
export default function UpgradeCardDisplay({
    ...
    if (upgradeTypes.length > 0 && upgradeTypes[0] === 'commander') {
        ...
        if (upgradeTypes[0] === 'title') {
            ...
            cardElements.push(
                <ForegroundWrapperElement key="titled-ship-icon" height={50 * sizeMultiplier} width={100 * sizeMultiplier} top={(armadaShipIconOffset[titledShip] ? armadaShipIconOffset[titledShip] : 0) + 557 * sizeMultiplier} left={10 * sizeMultiplier}>
