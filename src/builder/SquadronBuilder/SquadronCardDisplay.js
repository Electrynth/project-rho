...
export default function SquadronCardDisplay({
    ...
    if (firstDefenseToken) {
        cardElements.push(
            <ForegroundWrapperElement key="squadron-first-defense-token" height={35 * sizeMultiplier} width={50 * sizeMultiplier} top={faction === 'rebels' ? 574 * sizeMultiplier : 572 * sizeMultiplier} left={secondDefenseToken === 'none' ? 202 * sizeMultiplier : 175 * sizeMultiplier}>
    ...
    if (secondDefenseToken) {
        cardElements.push(
            <ForegroundWrapperElement key="squadron-second-defense-token" height={35 * sizeMultiplier} width={50 * sizeMultiplier} top={faction === 'rebels' ? 574 * sizeMultiplier : 572 * sizeMultiplier} left={230 * sizeMultiplier}>
